...
const Hero: React.FC = () => {
  return (
    <section className="relative bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white pt-32 pb-20 lg:pt-48 lg:pb-28 overflow-hidden transition-colors duration-300">
      {/* Background decorative blobs */}
      <div className="absolute top-0 right-0 -mr-40 -mt-40 w-96 h-96 rounded-full bg-brand-500/10 dark:bg-brand-500/20 opacity-50 blur-3xl animate-pulse"></div>
      <div className="absolute bottom-0 left-0 -ml-40 -mb-40 w-80 h-80 rounded-full bg-accent-500/10 dark:bg-accent-500/20 opacity-50 blur-3xl animate-pulse-slow"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-100 dark:bg-brand-500/10 border border-brand-200 dark:border-brand-500/30 text-brand-600 dark:text-brand-300 text-sm font-semibold mb-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white leading-tight mb-6">
              ...
              <span className="text-brand-500 dark:text-brand-400">Don't Just Mask Them.</span>
            </h1>
            <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start mb-12">
              ...
              <a href="#how-it-works" className="bg-slate-200/50 dark:bg-slate-800/50 hover:bg-slate-200 dark:hover:bg-slate-700/50 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 text-lg px-8 py-4 rounded-full font-semibold transition-all inline-block text-center">
                Learn How
              </a>
            </div>

            <div className="flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
          ...
          <div className="relative lg:h-auto">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-slate-100 dark:bg-slate-800 border-4 border-slate-200 dark:border-slate-700/50 aspect-square lg:aspect-[4/3] group">
               ...
               <div className="absolute bottom-6 left-6 bg-white/70 dark:bg-slate-900/50 backdrop-blur-md px-4 py-3 rounded-xl border border-slate-200 dark:border-white/10 shadow-lg">
                  <p className="text-sm font-bold text-slate-900 dark:text-white">Professional Strength</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Available in 3.4oz & 8oz</p>
               </div>
            </div>
            {/* Floating Badge */}
