        ...
        <main>
          ...
          <section id="reviews" className="py-20 bg-brand-50 dark:bg-slate-800/70 text-slate-900 dark:text-white text-center transition-colors duration-300">
            <div className="max-w-4xl mx-auto px-4">
              ...
              <blockquote className="text-2xl md:text-3xl font-medium italic mb-8 leading-relaxed text-slate-700 dark:text-slate-200">
          ...
          <section className="py-24 bg-white dark:bg-slate-900 text-center transition-colors duration-300">
            <div className="max-w-3xl mx-auto px-4">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-6">Ready for a fresh home?</h2>
              <p className="text-lg text-slate-600 dark:text-slate-400 mb-10">Join thousands of happy customers who have reclaimed their homes from pet odors.</p>
              ...
              <p className="mt-8 text-sm text-slate-400 dark:text-slate-500">30-Day Money Back Guarantee • Free Shipping on Orders $50+</p>
            </div>
          </section>
